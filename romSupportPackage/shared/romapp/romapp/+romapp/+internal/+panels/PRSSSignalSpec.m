classdef PRSSSignalSpec <  matlab.mixin.SetGet
    %
    ...
    properties(SetAccess=private)
        ...
        SignalTable
        Widgets
        Spec romapp.internal.data.PRSSSignalSpec
    end
    ...
    methods
        function this = PRSSSignalSpec(tool,spec,parent,row,col)
            % PRSSSIGNALSPEC
        ...
        function updateSpec(this,varargin)
            ...
            if nargin == 1
                setValues(this.Spec,pw,np,ranges); % update signal spec of this panel
            elseif nargin>1
                setValues(varargin{1},pw,np,ranges); % update a standalone signal spec
            end
        end
    ...
    methods (Access=private)
        function buildPanel(this,parent,row,col)
            ...
            editFieldNumP.Value = 10;
            labelSignalLimits = uilabel(layoutOptions);
            labelSignalLimits.Text = romapp.internal.resources.getString('lblPRSSSignalSpec_Limits');
